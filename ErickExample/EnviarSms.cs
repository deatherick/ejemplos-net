...
namespace ErickExample
{
    ...
    {
        internal string AccessKey { get; set; } = "AKIAIOTK4KTSY6IV2VJQ";
        internal string SecretKey { get; set; } = "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";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(response.MessageId);
        }
